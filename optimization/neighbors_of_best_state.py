...
output_file = "optimization/results/neighbors_of_best_state_from_random_walk_N50_under_erasure_channel_2nd.hdf5"
...
if __name__ == '__main__':
    ...
    parser.add_argument('-N', action="store", dest='N', default=50, type=int, required=False)
    parser.add_argument('-L', action="store", dest='L', default=1, type=int, required=False)
    parser.add_argument('-p', action="store", dest='p', default=0.03, type=float, required=False)
